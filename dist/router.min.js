...
console.warn("Page has no `close` method!"));m.Router.prototype.execute.apply(this,arguments)},logout:function(){l.del("/v1/session").end(function(){window.location.replace("/")})}});extractArguments=function(b,e){var k={},l=b.split("/");null==b&&(b="");null==e&&(e=[]);l=n.select(l,function(b){return":"==b[0]});n.each(l,function(b,l){var m=b.slice(1);k[m]=e[l]});return k};q.addRoute=function(b,e){var k=n.uniqueId("handler");if(!e.prototype.close)throw Error("Page must have a close method");this.prototype.routes[b]=
k;this.prototype[k]=function(){var k=extractArguments(b,Array.prototype.slice.apply(arguments));this.currentPage=new e({el:document.getElementById("page"),router:this,args:k})}};return q}},{q:1,superagent:2}],6:[function(n,q,t){function l(){}n=q.exports={};n.nextTick=function(){if("undefined"!==typeof window&&window.setImmediate)return function(k){return window.setImmediate(k)};if("undefined"!==typeof window&&window.postMessage&&window.addEventListener){var k=[];window.addEventListener("message",
function(l){var m=l.source;m!==window&&null!==m||"process-tick"!==l.data||(l.stopPropagation(),0<k.length&&k.shift()())},!0);return function(l){k.push(l);window.postMessage("process-tick","*")}}return function(k){setTimeout(k,0)}}();n.title="browser";n.browser=!0;n.env={};n.argv=[];n.on=l;n.addListener=l;n.once=l;n.off=l;n.removeListener=l;n.removeAllListeners=l;n.emit=l;n.binding=function(k){throw Error("process.binding is not supported");};n.cwd=function(){return"/"};n.chdir=function(k){throw Error("process.chdir is not supported");
}},{}]},{},[5])(5)});
